    ...
    public async Task ProcessState(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
    {
        ...
        switch (currentState)
        {
                ...
                if (update.CallbackQuery != null)
                {
                    ...
                    switch (callbackData)
                    {
                        case UsersAction.SEND_MEDIA_TO_ALL_CONTACTS:
                            ...
                            await botClient.EditMessageText(statusMessage.Chat.Id, statusMessage.MessageId, Localization.Get("ConfirmDecision"), replyMarkup: KeyboardUtils.GetConfirmForActionKeyboardMarkup(), cancellationToken: cancellationToken);
                            break;
                        ...
                        case UsersAction.SEND_MEDIA_TO_SPECIFIED_GROUPS:
                            ...
                            string text = $"{messageText}\n{Localization.Get("PleaseEnterContactIDs")}";
                        ...
                        case UsersAction.SEND_MEDIA_TO_SPECIFIED_USERS:
                            ...
                            await botClient.EditMessageText(statusMessage.Chat.Id, statusMessage.MessageId, Localization.Get("PleaseEnterContactIDs"), cancellationToken: cancellationToken);
                            currentState = UsersStandardState.ProcessData;
                            break;
            ...
            case UsersStandardState.ProcessData:
                ...
                {
                    await botClient.EditMessageText(statusMessage.Chat.Id, statusMessage.MessageId, Localization.Get("VideoDistributionQuestion"), replyMarkup: KeyboardUtils.GetVideoDistributionKeyboardMarkup(), cancellationToken: cancellationToken);
                    currentState = UsersStandardState.ProcessAction;
                    return;
                }
            ...
            case UsersStandardState.Finish:
                ...
                await botClient.EditMessageText(statusMessage.Chat.Id, statusMessage.MessageId, Localization.Get("WaitDownloadingVideo"), cancellationToken: cancellationToken);
