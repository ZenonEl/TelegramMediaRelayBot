...
public static class CallbackQueryMenuUtils
{
    ...
    public static async Task GetSelfLink(ITelegramBotClient botClient, Update update, IUserGetter userGetter)
    {
        ...
        await CommonUtilities.SendMessage(botClient, update, KeyboardUtils.GetReturnButtonMarkup(), cancellationToken, string.Format(Localization.Get("YourLink") + startLink, link));
    }
    ...
    {
        string text = Localization.Get("YourInboundInvitations");
    ...
    {
        string text = Localization.Get("YourOutboundInvitations");
        ...
        IUserGetter userGetter)
    {
        ...
        await CommonUtilities.SendMessage(botClient, update, OutBoundKB.GetOutboundActionsKeyboardMarkup(userId), cancellationToken, Localization.Get("OutboundInviteMenu"));
    ...
    {
        string text = Localization.Get("WhosTheGeniusText");
